    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="side-bar1">
                ...
                <br>
                <div class='pdesign'>
                    <p> Check which horizontal bar (Red, Yellow, Green or Blue) is overlapped with the<br> <b style="color:#FF50ED"> Vertical Purple</b>. Here, <b style="color:#FF50ED"> Vertical Pink</b> indicates the <b style="color:#D48C00">Given Value</b>.
